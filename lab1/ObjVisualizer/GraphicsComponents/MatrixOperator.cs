...
namespace ObjVisualizer.GraphicsComponents
{
    internal class MatrixOperator
    {
        ...
        {
            return new Matrix4x4(0, 0, 0, transition.X,
                                0,0, 0, transition.Y,
                                0, 0, 0, transition.Z,
                                0, 0, 0, 1.0f);
        }
        ...
        {
            return new Matrix4x4(1.0f, 0, 0, 0,
                                 0, 1.0f, 0, 0,
                                 0, 0, 1.0f, 0,
                                 0, 0, 0, 1.0f);
        }
        ...
        {
            return new Matrix4x4(1.0f / (camera.Aspect * (float)Math.Tan(camera.FOV / 2.0f)), 0, 0, 0,
        ...
        {
            return new Matrix4x4(Width >> 1, 0, 0, (Width - 1) >> 1,
