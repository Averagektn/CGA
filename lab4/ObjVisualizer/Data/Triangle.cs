...
{
    internal struct Triangle(Vector3 a, Vector3 b, Vector3 c, Vector3 NormA, Vector3 NormB, Vector3 NormC, Vector2 TextelA, Vector2 TextelB, Vector2 TextelC, Vector4 ViewA, Vector4 ViewB, Vector4 ViewC)
    {
